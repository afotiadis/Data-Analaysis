...
% Response: Y = bX + e
b = [0; 2; 0; -3; 0];
estd = 5; %Initializing the standard deviation of the noise
e = estd * randn(n,1);
y = x*b + e;
...
TSS = sum((y-muy).^2); %a value that will be used in R^2
[u,sigma,v] = svd(xc,'econ'); %for the SVD method and not only
